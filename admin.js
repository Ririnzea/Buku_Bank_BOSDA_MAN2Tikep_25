...
enerateReport() {
        ...
        reportResult.innerHTML = `
            ...
            <div class="summary-section" style="margin-bottom: 30px;">
                ...
                <table style="width: 100%; border-collapse: collapse; margin-bottom: 20px;">
                    <tr><td style="border: 1px solid #333; padding: 10px; font-weight: bold;">Total Transaksi</td><td style="border: 1px solid #333; padding: 10px; text-align: right;">${filteredTransactions.length}</td></tr>
                    <tr><td style="border: 1px solid #333; padding: 10px; font-weight: bold;">Total Penerimaan</td><td style="border: 1px solid #333; padding: 10px; text-align: right; color: #28a745;">${this.formatCurrency(totalPenerimaan)}</td></tr>
                    <tr><td style="border: 1px solid #333; padding: 10px; font-weight: bold;">Total Pengeluaran</td><td style="border: 1px solid #333; padding: 10px; text-align: right; color: #dc3545;">${this.formatCurrency(totalPengeluaran)}</td></tr>
                    <tr style="background: #f8f9fa;"><td style="border: 1px solid #333; padding: 10px; font-weight: bold;">Saldo Akhir</td><td style="border: 1px solid #333; padding: 10px; text-align: right; font-weight: bold;">${this.formatCurrency(saldo)}</td></tr>
                </table>
            </div>
            ...
            <div class="transaction-detail" style="margin-bottom: 40px;">
                ...
                <table style="width: 100%; border-collapse: collapse; font-size: 11px;">
                    <thead><tr style="background: #f8f9fa;">
                        ...
                        <th style="border: 1px solid #333; padding: 8px;">Tanggal</th>
                        <th style="border: 1px solid #333; padding: 8px;">No Bukti</th>
                        <th style="border: 1px solid #333; padding: 8px;">Uraian</th>
                        <th style="border: 1px solid #333; padding: 8px;">Kode Rekening</th>
                        <th style="border: 1px solid #333; padding: 8px;">Penerimaan</th>
                        <th style="border: 1px solid #333; padding: 8px;">Pengeluaran</th>
                        <th style="border: 1px solid #333; padding: 8px;">Saldo</th>
                    </tr></thead>
                    <tbody>
            ...
            <div class="signature-section" style="display: flex; justify-content: space-between; margin-top: 50px;">
                <div style="text-align: center; width: 45%;">
                    <p>Mengetahui</p><p><strong>Kepala Madrasah</strong></p>
                    <div style="height: 60px; margin: 15px 0;"></div>
                    <p><strong>${this.settings.namaKepala}</strong></p><p>${this.settings.nipKepala}</p>
                </div>
                <div style="text-align: center; width: 45%;">
                    <p>Tidore, ${new Date().toLocaleDateString('id-ID')}</p><p><strong>Bendahara BOSDA</strong></p>
                    <div style="height: 60px; margin: 15px 0;"></div>
                    <p><strong>${this.settings.namaBendahara}</strong></p><p>${this.settings.nipBendahara}</p>
                </div>
            </div>
   ...
   backupData() {
    ...
    generateCSV() {
        ...
        transactionsWithSaldo.forEach((transaction, index) => {
            const row = [
                index + 1, transaction.date, `"${transaction.bukti}"`, `"${transaction.uraian}"`,
                `"${transaction.kodeRekening}"`, transaction.penerimaan || 0, transaction.pengeluaran || 0, transaction.saldo
            ];
            csv += row.join(',') + '\n';
        });
        return csv;
